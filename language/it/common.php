...
$lang = array_merge($lang, array(
	...
	'MEILISEARCH_BANNER_VERSION_TITLE'	=> 'Meilisearch Search Backend versione %s',
	// Sinonimi
	'ACP_MEILISEARCH_SYNONYMS_EXPLAIN'	=> 'Parole che devono trovarsi a vicenda. Meilisearch le applica al momento della ricerca, quindi le modifiche hanno effetto dalla ricerca successiva senza reindicizzare.',
	'MEILISEARCH_SYN_LIST'				=> 'Gruppi di sinonimi',
	'MEILISEARCH_SYN_HOWTO_TITLE'		=> 'Come si scrive la lista',
	'MEILISEARCH_SYN_HOWTO'				=> 'Un gruppo per riga, termini separati da virgola. Ogni termine del gruppo trova tutti gli altri, in entrambe le direzioni. Una riga che inizia con <samp>#</samp> &egrave; un commento. I gruppi con un solo termine vengono ignorati, perch&eacute; una parola non &egrave; sinonimo di se stessa.<br /><br />Esempio:<br /><samp>sottotitoli, sub, subs<br />1080p, fullhd, full hd<br /># codici prodotto<br />r7, r-7</samp><br /><br />I termini sono confrontati senza distinguere maiuscole e minuscole, quindi non serve elencare le varianti con l&rsquo;iniziale maiuscola. I sinonimi agiscono al momento della ricerca: non cambiano ci&ograve; che &egrave; memorizzato e non richiedono alcuna reindicizzazione.',
	'MEILISEARCH_SYN_FIELD'				=> 'Gruppi',
	'MEILISEARCH_SYN_FIELD_EXPLAIN'		=> 'Fino a 500 gruppi da 20 termini ciascuno. I termini pi&ugrave; lunghi di 100 caratteri vengono ignorati.',
	'MEILISEARCH_SYN_COUNT'				=> 'Attualmente in uso',
	'MEILISEARCH_SYN_COUNT_VALUE'		=> '%1$d gruppi, %2$d termini',
	'MEILISEARCH_SYN_PREVIEW'			=> 'Cosa riceve Meilisearch',
	'MEILISEARCH_SYN_PREVIEW_EXPLAIN'	=> 'Meilisearch memorizza i sinonimi in una sola direzione, quindi ogni termine compare con i termini che far&agrave; trovare. Questa tabella &egrave; ci&ograve; che viene realmente inviato: se una corrispondenza non compare qui, sul forum non funzioner&agrave;.',
	'MEILISEARCH_SYN_TERM'				=> 'Cercando',
	'MEILISEARCH_SYN_MATCHES'			=> 'trova anche',
	'MEILISEARCH_SYN_SAVE'				=> 'Salva e applica',
	'MEILISEARCH_SYN_SAVED'				=> 'Salvata e applicata all&rsquo;indice: ora sono in uso %d gruppi.',
	'MEILISEARCH_SYN_NOT_APPLIED'		=> 'La lista &egrave; stata salvata ma non &egrave; stato possibile applicarla all&rsquo;indice: %s',
	'MEILISEARCH_SYN_NEEDS_TWO_TERMS'	=> 'La riga %d &egrave; stata ignorata: un gruppo richiede almeno due termini diversi.',
	'MEILISEARCH_SYN_TOO_MANY_TERMS'	=> 'La riga %d ha pi&ugrave; di 20 termini; quelli in eccesso sono stati scartati.',
	'MEILISEARCH_SYN_TOO_MANY_GROUPS'	=> 'Interrotto alla riga %d: la lista pu&ograve; contenere al massimo 500 gruppi.',

	'MEILISEARCH_ATTACH_NOTE'			=> 'I nomi dei file allegati e le relative didascalie sono indicizzati dalla versione 1.11.0. I documenti gi&agrave; presenti non li contengono finch&eacute; il forum non viene reindicizzato.',
	// Evidenziazione
	'MEILISEARCH_HIGHLIGHT'				=> 'Evidenzia le corrispondenze approssimate',
	'MEILISEARCH_HIGHLIGHT_EXPLAIN'		=> 'phpBB evidenzia le parole digitate dall&rsquo;utente. Meilisearch restituisce anche messaggi trovati tramite un refuso, un sinonimo o una diversa flessione, e quelle parole restano non evidenziate &mdash; cos&igrave; il risultato compare senza nulla di marcato e senza una ragione visibile. Con questa opzione attiva, l&rsquo;estensione chiede a Meilisearch quali parole ha realmente agganciato nella pagina mostrata e le aggiunge all&rsquo;evidenziazione di phpBB. <strong>Costo:</strong> una richiesta aggiuntiva per pagina di risultati, limitata ai messaggi di quella pagina. Su un&rsquo;istanza raggiunta via rete &egrave; un viaggio di andata e ritorno che il visitatore attende, quindi &egrave; disattivata di default. Controlla il tempo di risposta nella pagina di diagnostica prima di attivarla.',
	// Liste di sinonimi di partenza
	'MEILISEARCH_SYN_STARTER'			=> 'Liste di partenza',
	'MEILISEARCH_SYN_STARTER_EXPLAIN'	=> 'Con l&rsquo;estensione vengono fornite due liste gi&agrave; pronte, una italiana e una inglese. Coprono nomi delle lingue, formati video e audio, tipi di contenuto, termini informatici comuni e le espressioni che ricorrono su qualsiasi forum. Aggiungere inserisce nella casella qui sopra i gruppi che non hai gi&agrave;; sostituire scarta quello che c&rsquo;&egrave;.',
	'MEILISEARCH_SYN_STARTER_NOTE'		=> 'Caricare una lista riempie soltanto la casella &mdash; <strong>nulla viene salvato finch&eacute; non premi Salva e applica</strong>, quindi puoi rivedere e modificare prima. I file di partenza stanno dentro l&rsquo;estensione e vengono sostituiti a ogni aggiornamento, ed &egrave; voluto: cos&igrave; ricevi le correzioni insieme al codice. La tua lista invece &egrave; nel database e sopravvive intatta agli aggiornamenti.',
	'MEILISEARCH_SYN_REPLACE_CONFIRM'	=> 'Questo scarta tutto ci&ograve; che c&rsquo;&egrave; nella casella. Continuare?',
	'MEILISEARCH_SYN_STARTER_LOADED'	=> 'Lista caricata: la casella contiene ora %d gruppi. Premi Salva e applica per conservarli.',
	'MEILISEARCH_SYN_STARTER_MISSING'	=> 'Non &egrave; stato possibile leggere il file di partenza per &ldquo;%s&rdquo;. Verifica che la cartella data sia stata caricata insieme all&rsquo;estensione.',
	'MEILISEARCH_SYN_ADD_X'				=> 'Aggiungi la lista %s',
	'MEILISEARCH_SYN_REPLACE_X'			=> 'Sostituisci con la lista %s',
	'MEILISEARCH_SYN_NO_STARTERS'		=> 'Nessuna lista di partenza trovata. Verifica che la cartella data sia stata caricata insieme all&rsquo;estensione.',
	'MEILISEARCH_SYN_ADD_OWN'			=> 'Per aggiungere una lingua, metti un file chiamato <samp>synonyms_xx.txt</samp> nella cartella <samp>data</samp> dell&rsquo;estensione, dove <samp>xx</samp> &egrave; un codice breve a tua scelta. Scrivi <samp># name: Fran&ccedil;ais</samp> sulla prima riga per dargli un&rsquo;etichetta leggibile. I pulsanti qui sopra sono costruiti da ci&ograve; che si trova in quella cartella, quindi non c&rsquo;&egrave; codice da modificare. Caricala, poi premi Salva e applica: da quel momento la lista vive nel database e il file ha fatto il suo lavoro.',
	'MEILISEARCH_SYN_FILTER'			=> 'Filtra',
	'MEILISEARCH_SYN_FILTER_PLACEHOLDER'=> 'scrivi un termine per trovarlo',
	'MEILISEARCH_SYN_FILTER_NONE'		=> 'Nessun termine corrisponde al filtro.',
	'MEILISEARCH_SYN_TERMS_LABEL'		=> 'termini mostrati',
	'MEILISEARCH_HILIT_STYLE'			=> 'Rendi pi&ugrave; visibile l&rsquo;evidenziazione',
	'MEILISEARCH_HILIT_STYLE_EXPLAIN'	=> 'phpBB marca le parole trovate con un rosa smorto, difficile da distinguere, e i temi derivati da prosilver spesso lo attenuano ulteriormente fino a renderlo di fatto invisibile. Questa opzione lo sostituisce con un giallo chiaro nelle pagine di ricerca, il colore che i lettori associano gi&agrave; a &ldquo;questo &egrave; ci&ograve; che hai cercato&rdquo;. &Egrave; solo una regola di stile: nessuna richiesta aggiuntiva, nessun effetto oltre l&rsquo;aspetto. Disattivala se il tuo tema evidenzia gi&agrave; come desideri.',
));
